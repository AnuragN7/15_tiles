...
class Node(object):
	...
	def is_goal_node(self):
		""" Returns true if we have found the goal node """
	...
	def move_right(self, zero_index):
		...
		returns a child node to be added to the current node's 'children' list
		"""
	...
	def move_left(self, zero_index):
		""" Moves a zero to the left of the board
		
		Args:
		zero_item: Index where zero lies in the list
	...
	def move_up(self, zero_index):
		""" Moves a zero up the board 
	
		Args:
		zero_item: Index where zero lies in the list

		returns a child node to be added to the curren node's 'children' list
		"""
